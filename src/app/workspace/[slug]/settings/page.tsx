    ...
    <WorkspaceShell tenantName={tenant.publicName}>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[260px_1fr]">
        ...
        <div className="grid gap-6">
          ...
          <Card id="governance-&-authority"><h2 className="text-lg font-semibold">Governance & Authority</h2><p className="mt-2 text-sm text-muted">Dynamic roles, approval workflows, pastoral hierarchy, delegations, acting appointments, access reviews and diagnostics are managed in the authority workspace.</p><div className="mt-4"><a className="rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white" href={`/workspace/${tenant.slug}/authority`}>Open authority controls</a></div></Card>
