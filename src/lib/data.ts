...
export const roles: Role[] = [
  ...
  },
  {
    ...
    systemTemplate: true,
    permissions: ["tenant.view", "organization.view", "branch.view", "people.view", "visitor.view", "new_convert.view", "follow_up.view", "follow_up.assign", "child.view_basic", "pastoral_case.create", "pastoral_case.view_assigned", "pastoral_case.view_unit", "pastoral_case.update", "pastoral_case.assign", "pastoral_case.refer", "pastoral_case.close", "prayer_request.view", "prayer_request.assign", "counselling.manage", "pastoral_visit.manage", "bereavement.manage", "welfare_request.view", "welfare_request.assess"],
  },
  {
    id: "role-member",
    tenantId: "tenant-kings-grace",
