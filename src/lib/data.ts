import { administrationPermissionKeys, digitalPermissionKeys, intelligencePermissionKeys, productionPermissionKeys, subscriptionPlans, terminologyDefaults } from "./constants";
...
export const profiles: Profile[] = [
  ...
  { id: "user-superadmin", email: "platform-owner@kingdomflow.local", fullName: "Platform Owner" },
  { id: "user-admin", email: "church-admin@kingdomflow.local", fullName: "Church Administrator", phone: "+254700000001" },
  { id: "user-branch", email: "branch-leader@kingdomflow.local", fullName: "Branch Leader" },
  { id: "user-volunteer", email: "volunteer@kingdomflow.local", fullName: "Volunteer User" },
  { id: "user-test-all", email: "tester@kingdomflow.local", fullName: "Platform Tester" },
  { id: "user-finance", email: "finance@kingdomflow.local", fullName: "Finance User" },
  { id: "user-hr", email: "hr@kingdomflow.local", fullName: "HR User" },
  { id: "user-care", email: "care@kingdomflow.local", fullName: "Pastoral Care User" },
  { id: "user-member-demo", email: "member@kingdomflow.local", fullName: "Member User" },
];
