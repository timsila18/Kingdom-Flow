...
export const authorityRoles: Role[] = [
  ...
  },
  {
    ...
    approvalRequiredForAssignment: true,
    systemTemplate: true,
    permissions: ["tenant.view", "organization.view", "organization.view_descendants", "branch.view", "member.view", "pastoral_case.create", "pastoral_case.view_assigned", "pastoral_case.view_unit", "pastoral_case.update", "pastoral_case.refer", "pastoral_case.assign", "pastoral_case.close", "programme.view", "people.view", "visitor.view", "new_convert.view", "follow_up.view", "follow_up.assign", "child.view_basic", "prayer_request.view", "prayer_request.assign", "counselling.manage", "pastoral_visit.manage", "bereavement.manage", "welfare_request.view", "welfare_request.assess"],
  },
  {
