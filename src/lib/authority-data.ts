...
export const authorityRoles: Role[] = [
  ...
  },
  {
    ...
    approvalRequiredForAssignment: true,
    systemTemplate: true,
    permissions: ["tenant.view", "organization.view", "branch.view_consolidated", "programme.view", "programme.approve", "delegation.view", "audit.view", "people.view", "visitor.view", "new_convert.view", "follow_up.view"],
  },
  {
    id: "role-regional",
    tenantId: "tenant-kings-grace",
    ...
    approvalRequiredForAssignment: true,
    systemTemplate: true,
    permissions: ["tenant.view", "organization.view", "organization.view_descendants", "branch.view", "member.view", "pastoral_case.refer", "programme.view", "people.view", "visitor.view", "new_convert.view", "follow_up.view", "follow_up.assign", "child.view_basic"],
  },
  {
